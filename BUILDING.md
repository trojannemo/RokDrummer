# Building Rok Drummer from Source
...
git clone https://github.com/trojannemo/RokDrummer.git
...
RokDrummer\RokDrummer\bin\Debug\

(or `Release` if building Release)

## Step 4: Open Solution
Open `RokDrummer.sln` in Visual Studio.
...
I hope this helps more of you be able to compile and edit Rok Drummer
